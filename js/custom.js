...
$(function(){
	...
	var headingAnimate = function() {
		...
		setTimeout(function() {
			...
			.set('.sub-text,.homepage-logo, .js-line', {y: 20, autoAlpha: 0, transformStyle:"preserve-3d"})
			...
			.fromTo('.sub-text, .js-line, .homepage-logo', 1, { autoAlpha: 0, y: 20 }, { autoAlpha: 1, y: 0, ease: Expo.easeInOut }, '-=1')
		}, 300);
	};
	headingAnimate();
